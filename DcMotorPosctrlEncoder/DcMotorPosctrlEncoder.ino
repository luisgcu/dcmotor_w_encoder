/*
This Works perfectly  July 23, 2023

*/
#include <PID_v1.h> //https://github.com/br3ttb/Arduino-PID-Library/
#define MotEnable 5 //Motor Enamble pin Runs on PWM signal
#define MotFwd  12  // Motor Forward pin
...
int PPR = 3576;  // Encoder Pulse per revolution. was 3600  
//int PPR = 900;  // Encoder Pulse per revolution. Motor 2 https://www.amazon.com/Bemonoc-Encoder-Gearmotor-Two-Channel-Effect/dp/B07GNG5MZ1?th=1
...
int speedPos =150;
int speedNeg =-150;
double kp = 2 , ki = 1.5 , kd = 0.21;             // modify for optimal performance
...
void setup() {
  ...
  myPID.SetOutputLimits(speedNeg, speedPos); // this is the MAX PWM value to move motor, here change in value reflect change in speed of motor.
}
...
REV = map (User_Input, 0, 360, 0, PPR); // mapping degree into pulse  was 1600
